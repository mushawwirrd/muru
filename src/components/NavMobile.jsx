...
function NavMobile({ isOpen, setOpen }) {
    return (
        <div >
            ...
            <div className={`fixed z-[70] top-[4rem] right-0 text-center w-full rounded-b-3xl bg-white p-10 transition-transform duration-300 ${isOpen ? "translate-x-0 " : "translate-x-full "}`}>
